...
\usepackage{fontspec}
\usepackage{siunitx}      
\sisetup{detect-all}                % use main body font for units
...
\let\oldtext\text
\renewcommand{\text}[1]{\oldtext{\fontfamily{cmr}\selectfont #1}} % use math font in text
\DeclareSymbolFont{sfoperators}{OT1}{cmr}{m}{n}    % math operator font (log,argmax, etc.)
...
\begin{document} 	
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%
    \pagenumbering{roman}
	\includepdf[pages={1}]{sections/declaration.pdf}
...
% 	    \addsubsec{res}{best}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%
    \pagenumbering{roman}
	\includepdf[pages={-}]{sections/risk_assesment.pdf}
