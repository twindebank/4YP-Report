...
\label{sec:exp-clf}
    ...
    \label{subsec:exp-clf-overview}
        ...
        %These first-iteration optimised parameters are fed back to the start of the pipeline, replacing the initial assumptions and running the procedure until convergence is achieved. 
    ...
    \label{subsec:exp-clf-xval}
       ...
       \twN{need to reference back to an xval section. \\ok to treat this as i.i.d.?}
    ...
    \label{subsec:exp-clf-ass}
        ...
        \label{subsubsec:exp-clf-ass-trnlabel}
            ...
            As discussed in section \ref{fig:pl-data-audiolbls-comb}, there are six methods to create a binary consensus label. The \code{'conf'} label aggregation policy will be assumed initially because it is theleast likely to contain miss-labelled samples; for a sample to be miss-labelled all four people must label incorrectly. 
    ...
    \label{subsec:exp-clf-opt}
        ...
        \label{subsubsec:exp-clf-opt-featsel}
            ...
            \twN{need to write rfe section and explain RF-only support}
            ...
            %             \hline
            %             Classifier & Features & F$_{1}$ & AUC-ROC & AUC-PR & TPR & TNR \\ 
            %             \hline
            %             \hline
            ...
            %             \hline
            %             Classifier & \code{winlen} & \code{winstep} & F$_{1}$ & AUC-ROC & AUC-PR & TPR & TNR \\ 
            %             \hline
            %             \hline
        ...
        \label{subsubsec:exp-clf-opt-class}
            ...
            %             \hline
            %             Classifier & F$_{1}$ & ROC Area & TPR & TNR \\ 
            %             \hline
            %             \hline
            %             NB          & $0.$ & $0.$  & $0.$ & $0.$\\
            %             NB balanced & $0.$ & $0.$ & $0.$ & $0.$\\
        ...
        \label{subsubsec:exp-clf-opt-normaud}
            ...
            %         \begin{tabular}{ |l||c|c|c|c|c|c|c| } 
            %             \hline
            %             Classifier & \specialcell{Audio\\Normalised} & F$_{1}$ & AUC-ROC & AUC-PR & TPR & TNR \\ 
            %             \hline
            %             \hline
