...
\label{sec:exp-postproc}
    ...
    \twN{can say rejects at edges of pulses because when mos comiing in and out of frame, different headphones will cause labelers to label at different times,, show fuig}
